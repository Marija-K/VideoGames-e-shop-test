...
public class ShoppingCartController {
    ...
    public String getShoppingCartPage(@RequestParam(required = false) String error,
        ...
        model.addAttribute("videoGames", this.shoppingCartService.listAllGamesInShoppingCart(shoppingCart.getId()));
    ...
    public String addProductToShoppingCart(@PathVariable Long id, HttpServletRequest req, Authentication authentication) {
        try {
            ...
            this.shoppingCartService.addGameToShoppingCart(user.getUsername(), id);
