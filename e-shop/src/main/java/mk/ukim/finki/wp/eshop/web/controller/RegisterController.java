...
public class RegisterController {
    ...
    public String register(@RequestParam String username,
        ...
        try{
            this.userService.register(username, password, repeatedPassword, name, surname, role, birthday);
            return "redirect:/login";
        } catch (InvalidArgumentsException | PasswordsDoNotMatchException | ParseException exception) {
